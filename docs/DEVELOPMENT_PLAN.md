...
- P0-05（材质）和 P0-06（Packaging）尚未开始完成性验证；P0-07 已建立机器可校验的性能证据契约、通用进程资源采样器、确定性的 per-run Average/P95/P99/max 统计器、显式 cross-run median/worst 选择器、最终 evidence metadata 装配器及对应 CI tooling tests，但 Release x64 Zhuomian 场景编排、Baseline/Enhanced 实机结果和 provisional 阈值校准尚未完成，因此 P0-07 仍为未完成；P0-08 已完成。
