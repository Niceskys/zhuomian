...
- P0-05（材质）和 P0-06（Packaging）尚未开始完成性验证；P0-07 已建立机器可校验的性能证据契约与 CI 自测，但采样脚本、Baseline/Enhanced 实机结果和 provisional 阈值校准尚未完成，因此 P0-07 仍为未完成；P0-08 已完成。
- 产品正式实现仍未开始；现有 `spikes/`、测试参考模型和性能契约工具是可丢弃/可替换验证资产，不得直接视为 V0.1 生产实现。
